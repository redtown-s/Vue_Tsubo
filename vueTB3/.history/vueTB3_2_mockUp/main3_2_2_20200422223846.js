...
function hideNode(node) {
  node.setAttribute('style', 'display:none;'); //***.setAttribute(name,value);指定の要素に新しい属性を追加します。style=または指定の要素に存在する属性の値を変更します。name は属性の名前を文字列で表現したもの。value は属性の希望する新しい値
